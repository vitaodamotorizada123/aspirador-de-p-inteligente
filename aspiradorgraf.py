...
# Treinar e salvar histórico
history = model.fit(
    X, {"potencia": y_pot, "velocidade": y_vel},
...
# Potência
plt.subplot(1,2,1)
plt.plot(history.history["potencia_accuracy"], label="Acurácia Potência")
plt.plot(history.history["potencia_loss"], label="Loss Potência")
plt.title("Treinamento - Potência")
plt.xlabel("Épocas")
plt.ylabel("Valor")
plt.legend()
...
# Velocidade
plt.subplot(1,2,2)
plt.plot(history.history["velocidade_accuracy"], label="Acurácia Velocidade")
plt.plot(history.history["velocidade_loss"], label="Loss Velocidade")
plt.title("Treinamento - Velocidade")
plt.xlabel("Épocas")
plt.ylabel("Valor")
plt.legend()
